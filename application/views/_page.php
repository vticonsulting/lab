<main class="flex-1 p-8">
	<div class="lg:flex lg:items-center lg:justify-between">
		...
		<div class="flex mt-5 lg:mt-0 lg:ml-4">
			...
			<span class="sm:ml-3">
				<button type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-primary-600 border border-transparent rounded-md shadow-sm hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
					<!-- Heroicon name: check -->
