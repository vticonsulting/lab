					...
					<ol class="flex items-center space-x-4">
						<li>
							<div>
								...
								</a><a href="<?= base_url('dashboard') ?>" class="text-sm font-medium text-gray-400 hover:text-gray-200">Dashboard</a>
						...
						<li>
							<div class="flex items-center">
								...
								<a href="<?= base_url('organizations') ?>" class="ml-4 text-sm font-medium text-gray-400 hover:text-gray-200">My Organization</a>
							</div>
						</li>
						<li>
							<div class="flex items-center">
							...
							<tbody class="bg-white divide-y divide-gray-200">
								<tr>
									<td class="px-6 py-4 whitespace-nowrap">
										...
										<div class="flex-shrink-0 w-10 h-10">
											<img class="w-10 h-10 rounded-full" src="<?= base_url('assets/img/avatars/andy.jpg') ?>" alt="">
										</div>
										<div class="ml-4">
								...
								<tr>
									<td class="px-6 py-4 whitespace-nowrap">
										<div class="flex items-center">
										<div class="flex-shrink-0 w-10 h-10">
											<img class="w-10 h-10 rounded-full" src="<?= base_url('assets/img/avatars/victor.jpg') ?>" alt="">
										</div>
										<div class="ml-4">
											<div class="text-sm font-medium text-gray-900">
												Victor Tolbert
