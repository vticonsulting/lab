<main class="flex-1 p-8">
	<div class="lg:flex lg:items-center lg:justify-between">
		<div class="flex-1 min-w-0">
			<div class="flex items-baseline space-x-2">
				<h2 class="text-2xl leading-7 text-gray-900 sm:text-4xl sm:truncate">
					<?= $title ?>
				</h2>
				<span class="text-sm">[ <a href="#">Add New</a> ]</span>
			</div>
		</div>

		<div class="flex mt-5 lg:mt-0 lg:ml-4">
			<span class="hidden ml-3 sm:block">
				<button type="button" class="inline-flex items-center px-4 py-2 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
			...
			<span class="sm:ml-3">
				...
				<button type="button" class="inline-flex items-center px-4 py-2 text-base font-medium border rounded-md border-primary-400 whitespace-nowrap text-primary-700 bg-primary-100 hover:bg-primary-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
					<svg class="w-5 h-5 mr-2 -ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
			...
			<!-- Dropdown -->
			<span class="relative z-10 ml-3 sm:hidden">
	...
	<section class="p-8 mt-8 bg-white rounded shadow">
		<div id="calendar"></div>
	</section>
</main>
