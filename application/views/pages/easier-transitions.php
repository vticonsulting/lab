<main class="flex-1 bg-gray-300 text-gray-800">
	<header class="border-t-4 border-blue-700 bg-white shadow-md">
		<nav class="container mx-auto px-4 flex items-center justify-between py-4">
			...
			<div class="relative" x-data="{ isOpen: false }">
				...
				<ul
					x-show.transition.in.duration.200ms.opacity.scale.25.origin.top.right.out.duration.200ms.opacity.scale.25.origin.top.right="isOpen"
